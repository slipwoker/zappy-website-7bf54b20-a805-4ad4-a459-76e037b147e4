    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פלטפורמת מעבדות חשמל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7bf54b20-a805-4ad4-a459-76e037b147e4',
                    name: data.name || '',
                    email: data.email || '',
